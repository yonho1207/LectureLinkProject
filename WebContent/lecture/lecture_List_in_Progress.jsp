  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
	<script type="text/x-jquery-tmpl" id="itemTemplate">
		<li id="lectureList">
			...
			{{= lecture_teacher}}<br />
			{{= description}}<br /></p>
			<p style="position: relative; left: 300px; bottom: 280px;"><button type="button" class="btn btn-primary"
			 onclick="location.href='/LectureLinkProject/go_cmt_Fom?lecture_no={{= lecture_no}}&reqPage=1'" >
			講義詳細</button></p>
			<p style="position: relative; left: 300px; bottom: 260px;"><button type="button" class="btn btn-primary"
			 onclick="location.href='/LectureLinkProject/go_Lecture_attend.do?lecture_no={{= lecture_no}}'" >
			講義ページへ</button></p>
		</li>
	</script>
